...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private static final int GITHUB_SEARCH_LOADER = 97;
    ...
    private void makeGithubSearchQuery() {
        ...
        // DNOE (20) Use putString with SEARCH_QUERY_URL_EXTRA as the key and the String value of the URL as the value
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                try {
                    URL stringAsURL = new URL(url);
                    githubSearchResults = NetworkUtils.getResponseFromHttpUrl(stringAsURL);
                } catch (IOException e) {
                    e.printStackTrace();
                }
