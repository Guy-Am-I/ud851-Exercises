...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        ...
        String webpage = "https://https://openweathermap.org/current";

        // DONE (6) Replace the Toast with a call to openWebPage, passing in the URL String from the previous step
        //Toast.makeText(this, "TO-DO: Open a web page when this button is clicked", Toast.LENGTH_SHORT).show();
        openWebPage(webpage);
    }
    ...
    public void openWebPage(String url) {
        ...
        goToPage.putExtra("webpageURI", webPageURI);
        */
        if(intent.resolveActivity(getPackageManager()) != null) { //must add for implicit intents
